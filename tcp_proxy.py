#!/usr/bin/python
# Building a TCP Proxy, Chapter 2
# Black Hat Python
import sys
import socket
import threading
...
def proxy_handler(client_socket, remote_host, remote_port, receive_first):
    ...
    if receive_first:
        ...
        # Send data to local client if exists
    ...
    while True:
        ...
        if len(local_buffer):
            ...
            if not len(local_buffer) or not let(remote_buffer):
                client_socket.close()
                remote_socket.close()
...
def server_loop(local_host, local_port, remote_host, remote_port,
    ...
    while True:
        ...
        proxy_thread = threading.Thread(
            target=proxy_handler, args=(client_socket, remote_host,
...
def main():
    ...
    # This tells the proxy to connect and receive data before sending
    # to the remote host
